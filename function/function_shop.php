<?php
        ...
        while($row_brand=mysqli_fetch_array($run_brand)){
            ...
            echo "
                ...
                <li>
                    ...
                    <a href='shop.php?brand=$brand_id'> $brand_title </a>
        ...
        while($row_model=mysqli_fetch_array($run_model)){
            ...
            echo "
                ...
                <li>
                    ...
                    <a href='shop.php?models=$model_id'> $model_title </a>
    ...
    function getPro(){
        ...
        $get_pro = "select * from products_all order by 1 DESC LIMIT 0,6";

        $run_pro = mysqli_query($con,$get_pro);

        while($row_pro=mysqli_fetch_array($run_pro)){

            $product_id = $row_pro['pro_w_id'];
    ...
    function getCatBrand()
    {
        ...
        if(isset($_GET['brand'])){
            ...
            $get_products = "select * from products_all where brand_id = '$brand_id'";
    ...
    function getCatModel()
    {
        ...
        if(isset($_GET['models'])){
            ...
            $get_products = "select * from products_all where model_id = '$model_id'";
