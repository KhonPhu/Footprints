<?php
        ...
        while($row_brand=mysqli_fetch_array($run_brand)){
            ...
            echo "
                ...
                <li>
                    ...
                    <a href='men.php?brand=$brand_id'> $brand_title </a>
        ...
        while($row_model=mysqli_fetch_array($run_model)){
            ...
            echo "
                ...
                <li>
                    ...
                    <a href='men.php?models=$model_id'> $model_title </a>
            ...
            while($row_products = mysqli_fetch_array($run_products))
            {
                ...
                <div class='col-md-4 col-sm-6 center-responsive'>
                    ...
                    <div class='product'>
                        ...
                        <a href='details.php?prducto_id=$product_id'>
    ...
    function getCatModel()
    {
        ...
        if(isset($_GET['models'])){
            ...
            $get_products = "select * from products where model_id = '$model_id'";
